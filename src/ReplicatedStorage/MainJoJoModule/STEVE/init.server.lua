...
local StandName = "Steve Platinum"
local ModelCreator = "pateabo"
...
function CreateEffect(Parent, EffectType, EffectColor)
	...
	elseif EffectType == "BarrageArm" then
		...
		coroutine.resume(coroutine.create(function()
			for i = 1,27 do
				game:GetService("RunService").RenderStepped:Wait()
				FadeArm.SteveArm.Transparency = FadeArm.SteveArm.Transparency + 0.06
				for Index,Child in next, FadeArm.SteveArm:GetChildren() do
