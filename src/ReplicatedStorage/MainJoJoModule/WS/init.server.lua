...
local StandName = "Whitesnake"
local ModelCreator = "thebigyeet12 & TheGuestToBlame"
			...
			elseif Stealing == true then
				if Humanoid.Parent:FindFirstChild("StandValue") then
					if CurrentDisc == nil then
						if Humanoid.Parent["StandValue"].Value == "The World Over Heaven" or Humanoid.Parent["StandValue"].Value == "Made In Heaven" or Humanoid.Parent["StandValue"].Value == "Golden Experience Requiem" or Humanoid.Parent["StandValue"].Value == "Silver Chariot Requiem" or Humanoid.Parent["StandValue"].Value == "HOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOW3rTFEVW%ZVGAE%$Z&HOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOWHOW" or Humanoid.Parent["StandValue"].Value == "The World Requiem" or Humanoid.Parent["StandValue"].Value == "Star Platinum Requiem" or Humanoid.Parent["StandValue"].Value == "Star Platinum Over Heaven" or Humanoid.Parent["StandValue"].Value == "Justice for All" then
						...
						--[[ Old method of resetting character to remove the stand
						...
						if StandPlayer:FindFirstChildOfClass("PlayerGui"):FindFirstChild("MoveList") then
							StandPlayer:FindFirstChildOfClass("PlayerGui")["MoveList"]:Destroy()
						end
						if StandPlayer:FindFirstChildOfClass("PlayerGui"):FindFirstChild("ClockGui") then
							StandPlayer:FindFirstChildOfClass("PlayerGui")["ClockGui"]:Destroy()
						end
						local NewChar = workspace:WaitForChild(StandPlayer.Name)
						NewChar:SetPrimaryPartCFrame(Frame)
						]]
						local StandScript = StandPlayer.Character[StandPlayer.Name.."'s "..StandPlayer.Character["StandValue"].Value]
						StandScript.Disabled = true
						StandScript:Destroy()
						StandPlayer.Character.StandValue:Destroy()
						if StandPlayer.Character:FindFirstChild("CanDodge") then
							StandPlayer.Character.CanDodge:Destroy()
						end
						if StandPlayer.Character:FindFirstChild("IsTSImmune") then
							StandPlayer.Character.IsTSImmune:Destroy()
						end
						if StandPlayer.Character:FindFirstChild("CanDodgeInTS") then
							StandPlayer.Character.CanDodgeInTS:Destroy()
						end
						if StandPlayer.Character.Head:FindFirstChild("Stand") then
							StandPlayer.Character.Head.Stand:Destroy()
						end
						StandPlayer.Character.StandInputClient.Disabled = true
						StandPlayer.Character.StandInputClient:Destroy()
						StandPlayer.Character.StandInput:Destroy()
						StandPlayer.Character.GetClientPropertyStandInput:Destroy()
						if StandPlayer:FindFirstChildOfClass("PlayerGui"):FindFirstChild("MoveList") then
							StandPlayer:FindFirstChildOfClass("PlayerGui")["MoveList"]:Destroy()
						end
						if StandPlayer:FindFirstChildOfClass("PlayerGui"):FindFirstChild("ClockGui") then
					...
					if CurrentDisc == nil then
						...
						if NoStandPlayer then
							...
							elseif CurrentDisc == "Silver Chariot" then
								require(StandRequire)("SC", NoStandPlayer.Name)
							elseif CurrentDisc == "Sans Crimson" then
								require(StandRequire)("SansC", NoStandPlayer.Name)
							elseif CurrentDisc == "Killer Queen" then
								require(StandRequire)("KQ", NoStandPlayer.Name)
							elseif CurrentDisc == "Bruh World" then
								require(StandRequire)("MTW", NoStandPlayer.Name)
							end
							CurrentDisc = nil
						else
							CreateSound(HitSound, Toucher, 3, math.random(95,113)/100, 0, false, false, "Hit SFX")
...
function Stand()
	...
	if CurrentStand == nil then
		...
		CreateSound(3947406655, Head, 1.9, 1, 0, false, false, "Stand Call")
		...
		for Index,Child in next, CurrentStand:GetDescendants() do
			if (Child:IsA("BasePart") or Child:IsA("Decal")) and Child.Name ~= "RootPart" and Child.Name ~= "Head" and Child.Name ~= "Disc" and Child.Name ~= "Gun" then
		...
		for i = 0,1,0.02 do
			game:GetService("RunService").RenderStepped:Wait()
			CurrentStand.PrimaryPart.CFrame = CurrentStand.PrimaryPart.CFrame:Lerp(Root.CFrame * CFrame.new(-2.5, 1.3, 2.5), 0.2)
			CurrentStand.RootPart["Root Joint"].C0 = CurrentStand.RootPart["Root Joint"].C0:Lerp(AnimDefaults.tors0*CFrame.new(0, 0, 0.8*math.sin(Sine/145))*CFrame.Angles(0, 0, math.rad(-27)), 0.23)
			CurrentStand.StandTorso["Left Hip"].C0 = CurrentStand.StandTorso["Left Hip"].C0:Lerp(AnimDefaults.lleg*CFrame.new(0.058, 0, -0.014) * CFrame.Angles(math.rad(-2.979), math.rad(11.001), math.rad(1.318)), 0.23)
			CurrentStand.StandTorso["Right Hip"].C0 = CurrentStand.StandTorso["Right Hip"].C0:Lerp(AnimDefaults.rleg*CFrame.new(-0.058, 0, 0.014) * CFrame.Angles(math.rad(-6.875), math.rad(-6.073), math.rad(0.974)), 0.23)
			CurrentStand.StandTorso["Left Shoulder"].C0 = CurrentStand.StandTorso["Left Shoulder"].C0:Lerp(AnimDefaults.larm*CFrame.new(-0.077, 0.25, -0.311) * CFrame.Angles(math.rad(45.951), math.rad(9.912), math.rad(-20.512)), 0.23)
			CurrentStand.StandTorso["Right Shoulder"].C0 = CurrentStand.StandTorso["Right Shoulder"].C0:Lerp(AnimDefaults.rarm*CFrame.new(0, 0.13, 0) * CFrame.Angles(math.rad(14.782), math.rad(2.807), math.rad(10.371)), 0.23)
			CurrentStand.StandTorso.Neck.C0 = CurrentStand.StandTorso.Neck.C0:Lerp(AnimDefaults.head*CFrame.Angles(math.rad(-1.432), math.rad(5.844), math.rad(12.089)), 1)
		end
	else
		for Index,Child in next, CurrentStand:GetDescendants() do
			if Child:IsA("BasePart") or Child:IsA("Decal") then
...
function Barrage(Times, NeutralStop, BarrageSFX, Tpos)
	...
	local Done = false
	local Repeat = Times
	CreateSound(3794307152, CurrentStand.Head, 4, 1, 0.2, false, false, "Call")
...
function ShootGun()
		...
		if Hit ~= nil and IsAHumanoid(Hit) and not Hit:IsDescendantOf(Character) then
			...
			if Humanoid.Parent:FindFirstChild("ReturnStandDamage") then
				if Humanoid.Parent.ReturnStandDamage.Value == true then
					...
					Val.Value = "Missed Hit"
					game:GetService("Debris"):AddItem(Val, 0.2)
					CreateSound(3092866899, Root, 3, math.random(99,103)/100, 0, false, false, "Hit SFX")
					Hum:TakeDamage(Damage)
					CreatePopUpGui(Root, "Jump", tostring(Damage), Color3.fromRGB(188, 0, 0))
					DoDamage = false
				end
	...
	until MouseHold == false or workspace:FindFirstChild("IsTimeStopped")
	coroutine.resume(coroutine.create(function()
		for i = 1, 22 do
			game:GetService("RunService").RenderStepped:Wait()
			CurrentStand["Right Arm"].Gun.Transparency = CurrentStand["Right Arm"].Gun.Transparency + 0.15
...
function StrongPunch()
	...
	local WalkSpeed = Hum.WalkSpeed
	Hum.WalkSpeed = 7
	CreateSound(4653946535, CurrentStand.Head, 6.5, math.random(97,103)/100, 0, false, false, "Strong Shout")
	for i = 0,1,0.05*AttackSpeed/0.75 do
		game:GetService("RunService").RenderStepped:Wait()
		CurrentStand.RootPart["Root Joint"].C0 = CurrentStand.RootPart["Root Joint"].C0:Lerp(AnimDefaults.tors0*CFrame.Angles(math.rad(35.008), math.rad(0.172), math.rad(-1.547)), i)
		CurrentStand.StandTorso["Left Hip"].C0 = CurrentStand.StandTorso["Left Hip"].C0:Lerp(AnimDefaults.lleg*CFrame.new(0.055, -0.008, -0.009) * CFrame.Angles(math.rad(2.75), math.rad(5.386), math.rad(14.037)), i)
...
function DiscMove()
	...
	CreateSound(3378197368, CurrentStand.Head, 6.5, math.random(97,103)/100, 0, false, false, "Strong Shout")
	for i = 0,1,0.018*AttackSpeed/0.75 do
		game:GetService("RunService").RenderStepped:Wait()
		CurrentStand.RootPart["Root Joint"].C0 = CurrentStand.RootPart["Root Joint"].C0:Lerp(AnimDefaults.tors0*CFrame.Angles(math.rad(35.008), math.rad(0.172), math.rad(-1.547)), i)
		CurrentStand.StandTorso["Left Hip"].C0 = CurrentStand.StandTorso["Left Hip"].C0:Lerp(AnimDefaults.lleg*CFrame.new(0.055, -0.008, -0.009) * CFrame.Angles(math.rad(2.75), math.rad(5.386), math.rad(14.037)), i)
		CurrentStand.StandTorso["Right Hip"].C0 = CurrentStand.StandTorso["Right Hip"].C0:Lerp(AnimDefaults.rleg*CFrame.new(0.977, 0.511, -0.028) * CFrame.Angles(math.rad(-3.037), math.rad(3.151), math.rad(-12.662)), i)
	...
	for i = 0,1,0.011*AttackSpeed/0.75 do
		game:GetService("RunService").RenderStepped:Wait()
		CurrentStand.RootPart["Root Joint"].C0 = CurrentStand.RootPart["Root Joint"].C0:Lerp(AnimDefaults.tors0*CFrame.Angles(math.rad(33.289), math.rad(-11.631), math.rad(-18.908)), i)
		CurrentStand.StandTorso["Left Hip"].C0 = CurrentStand.StandTorso["Left Hip"].C0:Lerp(AnimDefaults.lleg*CFrame.new(0.056, -0.008, 0.011) * CFrame.Angles(math.rad(11.918), math.rad(17.704), math.rad(12.089)), i)
		CurrentStand.StandTorso["Right Hip"].C0 = CurrentStand.StandTorso["Right Hip"].C0:Lerp(AnimDefaults.rleg*CFrame.new(0.971, 0.512, -0.238) * CFrame.Angles(math.rad(-10.6), math.rad(13.522), math.rad(-11.173)), i)
...
Mouse.KeyDown:Connect(function(Key)
	...
	if Key == "e" and Move == false then
		BarrageDown = true
		Barrage(20, false, 147722227, 0.15)
	end
