...
local StandName = "The World Over Heaven"
...
function BarragePunch()
	...
	StrongMUDA = true
	local MUDA = CreateSound(4748347334, CurrentStand.Head, 6.2, 1, 0, false, false, "Barrager")
...
function TimeStop()
	...
	local StopAudio = CreateSound(4729774926, Head, 6.5, 1, 0, false, true, "Stop Shout")
...
Mouse.KeyDown:Connect(function(Key)
	...
	if Key == "g" then
		...
		CreateSound(2390708644, Head, 7.5, 1, 0.2, false, false, "Greatest Height")
