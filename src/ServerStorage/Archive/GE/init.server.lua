...
local StandName = "Golden Experience"
...
function Stand()
	...
	if CurrentStand == nil then
		...
		CreateSound(4748348137, Head, 5, 1, 0, false, false, "Stand Call")
		...
		for i = 0,1,0.02 do
			...
			CurrentStand.RootPart["Root Joint"].C0 = CurrentStand.RootPart["Root Joint"].C0:Lerp(AnimDefaults.tors0*CFrame.new(0, 0, 0.8*math.sin(Sine/75))*CFrame.Angles(0, 0, math.rad(-57.983)), 0.23)
			CurrentStand.StandTorso["Left Hip"].C0 = CurrentStand.StandTorso["Left Hip"].C0:Lerp(AnimDefaults.lleg*CFrame.new(0.402, 0, -0.115) * CFrame.Angles(math.rad(-6.933), math.rad(45.722), math.rad(6.188)), 0.23)
			CurrentStand.StandTorso["Right Hip"].C0 = CurrentStand.StandTorso["Right Hip"].C0:Lerp(AnimDefaults.rleg*CFrame.new(-0.106, 0.02, 0.17) * CFrame.Angles(math.rad(-7.334), math.rad(-25.84), math.rad(2.12)), 0.23)
			CurrentStand.StandTorso["Left Shoulder"].C0 = CurrentStand.StandTorso["Left Shoulder"].C0:Lerp(AnimDefaults.larm*CFrame.new(-0.221, 0.24, -0.138) * CFrame.Angles(math.rad(31.971), math.rad(10.141), math.rad(-16.902)), 0.23)
			CurrentStand.StandTorso["Right Shoulder"].C0 = CurrentStand.StandTorso["Right Shoulder"].C0:Lerp(AnimDefaults.rarm*CFrame.Angles(math.rad(-16.329), math.rad(-22.288), math.rad(-5.73)), 0.23)
			CurrentStand.StandTorso.Neck.C0 = CurrentStand.StandTorso.Neck.C0:Lerp(AnimDefaults.head*CFrame.Angles(0, 0, math.rad(48.014)), 1)
		end
	else
		for Index,Child in next, CurrentStand:GetDescendants() do
			if Child:IsA("BasePart") or Child:IsA("Decal") then
...
function Barrage(Times, NeutralStop, BarrageSFX, External)
	...
	local Done = false
	local Repeat = Times
	local BarrageSound = CreateSound(BarrageSFX, CurrentStand.Head, 3.25, 1, 0.1, not NeutralStop, not NeutralStop, "Barrage Shout")
...
function StrongPunch()
	...
	local WalkSpeed = Hum.WalkSpeed
	Hum.WalkSpeed = 7
	CreateSound(4748348740, CurrentStand.Head, 6.5, math.random(97,105)/100, 0.06, false, false, "Strong Shout")
...
Mouse.KeyDown:Connect(function(Key)
	...
	if Key == "e" and Move == false then
		BarrageDown = true
		Barrage(30, false, 4748349503, true)
	end
