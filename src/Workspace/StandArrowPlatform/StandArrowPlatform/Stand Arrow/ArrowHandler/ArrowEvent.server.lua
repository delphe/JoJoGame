...
--require(StandRequire)("SPR", Player.Name)

local Rand = math.random(1, 2)
if Rand == 1 then
	require(StandRequire)("JLM", Player.Name)
elseif Rand == 2 then
	require(StandRequire)("STV", Player.Name)
else
	--this should never be reached unless you modify Rand and forget to include an elseif for it
	require(StandRequire)("SANS", Player.Name)
end
